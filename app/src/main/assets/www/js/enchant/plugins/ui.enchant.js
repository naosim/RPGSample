...
enchant.ui_assetName = {
  pad: 'img/enchant/pad2.png',
  apad: 'img/enchant/apad.png',
  icon0: 'img/enchant/icon0.png',
  font0: 'img/enchant/font0.png',
}
 ...
 */
enchant.ui = { assets: [
  enchant.ui_assetName.pad,
  enchant.ui_assetName.apad,
  enchant.ui_assetName.icon0,
  enchant.ui_assetName.font0
] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        var image = core.assets[enchant.ui_assetName.pad];
        enchant.Sprite.call(this, image.width / 2, image.height);
        this.image = image;
        this._maxRadius_2 = Math.pow(image.width / 2, 2);
        this._minRadius_2 = Math.pow(image.width * 0.05, 2);
    ...
    _detectInput: function(x, y) {
        ...
        if (x * x + y * y <= this._maxRadius_2 && x * x + y * y > this._minRadius_2) {
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode) {
        var core = enchant.Core.instance;
        var image = core.assets[enchant.ui_assetName.apad];
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets[enchant.ui_assetName.font0],
...
enchant.ui.LifeLabel = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(x, y, maxlife) {
        ...
        for (var i = 0; i < this._maxlife; i++) {
            ...
            this.heart[i].image = enchant.Game.instance.assets[enchant.ui_assetName.icon0];
